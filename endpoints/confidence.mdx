...
| `directional` | &lt;60% completeness or critical fetcher (PDL / Crustdata) failed. Treat the composite as a rough position, not a precise reading. |
...
```json
{
  ...
  "completeness_pct": 51,
  "failed_fetchers": ["pdl"],
  "data_warnings": ["pdl_no_founder_data"],
  "missing_signals": [
